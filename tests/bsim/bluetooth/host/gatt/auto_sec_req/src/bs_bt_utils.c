...
void disconnect(void)
{
	...
	ASSERT(!err, "bt_conn_disconnect failed (%d)\n", err);
}
...
void create_adv(struct bt_le_ext_adv **adv)
{
	...
	ASSERT(!err, "bt_le_ext_adv_create failed (%d)\n", err);
}
...
void start_adv(struct bt_le_ext_adv *adv)
{
	...
	ASSERT(!err, "bt_le_ext_adv_start failed (%d)\n", err);
}
...
void stop_adv(struct bt_le_ext_adv *adv)
{
	...
	ASSERT(!err, "bt_le_ext_adv_stop failed (%d)\n", err);
}
